...
insert into feeders (name, active, capacity,load, type, status, user_id) VALUES ('F3',false,2000,267,'SCALES','ACTIVE',1);
...
insert into feeders (name, active, capacity, type, status, user_id,schedule_id) VALUES ('F6',false,2000,'TIMER','ACTIVE',1,3);
