...
@RequestMapping("/cat-feeder/{userId}/schedule")
...
public class ScheduleController {
	...
	public ScheduleDTO updateSchedule(@PathVariable Long userId, @PathVariable Long scheduleId,
		@Valid @RequestBody ScheduleDTO dto) {
		return scheduleService.updateSchedule(userId, scheduleId, dto);
	}
